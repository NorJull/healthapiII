	...
	public List<RegistroAIEPIResult> obtenerResgitrosAIEPIsPorPaciente(int pacienteId) {
		...
		try {
			...
			Query theQuery = session.createQuery(
					"select mr.id as id, mr.pacienteId as pacienteId, mr.fechaEntrada as fecha, mr.horaEntrada as hora, mr.esParticular as esParticular, mr.motivoConsulta as motivoConsulta from RegistroAIEPIResult mr where mr.pacienteId = :pacienteId");
